...
public class AdventDay11
{
	...
	private static void part1() throws IOException
	{
		try (BufferedReader in = readInput()) {
			...
			System.out.println("Part 1 - Answer %d".formatted(skyMap.sumDistancesBetweenGalaxies()));
		}
	}
	...
	private static void part2() throws IOException
	{
		try (BufferedReader in = readInput()) {
			final var skyMap = SkyMap.parseInput(in);
			System.out.println("Part 2 - Answer %d".formatted(skyMap.sumDistancesBetweenGalaxiesInOlderUniverse()));
		}
	}
