...
public class AdventDay10
{
	...
	private static void part1() throws IOException
	{
		try (BufferedReader in = readInput()) {
			final var map = HikingMap.parseInput(in);
			System.out.println("Part 1 - Answer %d".formatted(map.scoreHikingTrails()));
		}
	}
	...
	private static void part2() throws IOException
	{
		try (BufferedReader in = readInput()) {
			final var map = HikingMap.parseInput(in);
			System.out.println("Part 2 - Answer %d".formatted(map.rateHikingTrails()));
		}
	}
