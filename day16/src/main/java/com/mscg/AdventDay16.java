...
public class AdventDay16
{
	...
	private static void part1() throws IOException
	{
		try (BufferedReader in = readInput()) {
			final var maze = ReindeerMaze.parseInput(in);
			System.out.println("Part 1 - Answer %d".formatted(maze.findBestPathCost()));
		}
	}
	...
	private static void part2() throws IOException
	{
		try (BufferedReader in = readInput()) {
			final var maze = ReindeerMaze.parseInput(in);
			System.out.println("Part 2 - Answer %d".formatted(maze.findTilesWithBestPath()));
		}
	}
