...
public class AdventDay13
{
	...
	private static void part1() throws IOException
	{
		try (BufferedReader in = readInput()) {
			final var ashMap = AshMap.parseInput(in);
			System.out.println("Part 1 - Answer %d".formatted(ashMap.summarize()));
		}
	}
	...
	private static void part2() throws IOException
	{
		try (BufferedReader in = readInput()) {
			final var ashMap = AshMap.parseInput(in);
			System.out.println("Part 2 - Answer %d".formatted(ashMap.summarizeSmudged()));
		}
	}
