...
public class AdventDay12
{
	...
	private static void part1() throws IOException
	{
		try (BufferedReader in = readInput()) {
			final var garden = Garden.parseInput(in);
			System.out.println("Part 1 - Answer %d".formatted(garden.computeFenceCost()));
		}
	}
	...
	private static void part2() throws IOException
	{
		try (BufferedReader in = readInput()) {
			final var garden = Garden.parseInput(in);
			System.out.println("Part 2 - Answer %d".formatted(garden.computeFenceDiscountedCost()));
		}
	}
