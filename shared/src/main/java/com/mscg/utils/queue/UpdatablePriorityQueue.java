...
public class UpdatablePriorityQueue<E> implements UpdatableQueue<E>
{
	 ...
	 * @throws ClassCastException   if the specified element cannot be compared with elements currently in this priority queue according to the
