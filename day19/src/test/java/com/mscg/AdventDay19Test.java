...
public class AdventDay19Test {
        ...
        public void testValidMessages2WithPatch() throws Exception {
                ...
                Assertions.assertArrayEquals(new String[] { "bbabbbbaabaabba", "babbbbaabbbbbabbbbbbaabaaabaaa",
        ...
        private BufferedReader readInput() {
                return new BufferedReader(new InputStreamReader(this.getClass().getResourceAsStream("/test-input.txt"),
                                StandardCharsets.UTF_8));
        }

        private BufferedReader readInput2() {
                return new BufferedReader(new InputStreamReader(this.getClass().getResourceAsStream("/test-input2.txt"),
                                StandardCharsets.UTF_8));
        }
